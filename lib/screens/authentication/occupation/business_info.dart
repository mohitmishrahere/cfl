...
class BusinessInfo extends StatelessWidget {
  ...
  final BusinessInfoController cont = Get.put(BusinessInfoController());

  @override
  Widget build(BuildContext context) {
    // pinController.text = '______';
    return Scaffold(
      body: GetBuilder<BusinessInfoController>(
        builder: (controller) {
          return Container(
            height: MediaQuery
                .of(context)
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (_) {
                                if(_.isNotEmpty && cont.shopAddress.text.isNotEmpty && cont.pincode.length==6){
                        ...
                        Container(
                            ...
                            child: TextField(
                              ...
                              // keyboardType: TextInputType.number,
                              onChanged: (_) {
                                if(_.isNotEmpty && cont.shopName.text.isNotEmpty && cont.pincode.length==6){
                                  cont.allFieldsEntered.value = true;
                                }else{
                                  cont.allFieldsEntered.value = false;
                                }
                        ...
                        Container(
                            ...
                            child: TextField(
                              ...
                              keyboardType: TextInputType.number,
                              onChanged: (_) {
                                if(_.length==6 && cont.shopName.text.isNotEmpty && cont.shopAddress.text.isNotEmpty){
                                  cont.allFieldsEntered.value = true;
                                }else{
                                  cont.allFieldsEntered.value = false;
                                }
                        ...
                        Obx(()=>Row(
                            ...
                            children: [
                              cont.isLoading.value ? CircularProgressIndicator() : Opacity(
                                opacity: cont.isUploaded.value && cont.allFieldsEntered.value ? 1.0 : 0.5,
                                child: InkWell(
                                  onTap: () async {
                                    if (cont.isUploaded.value) {
                                      ...
                                      var response = await APIServices
                                          .saveOccupationInfo(
                                          true, cont.shopName.text, cont.shopAddress.text,
                                          cont.pincode.text, cont.uploadedImageAddress.value);
                                      if(response.containsKey('message') && response['message']=='Information saved successfully'){
                                      ...
                                      }else if(response.containsKey('message') && response['message']=='Occupation details exists for this user..'){
                                        cont.isLoading.value = false;
                                        Fluttertoast.showToast(msg: 'Successfull');
                                        SharedPreferences prefs = await SharedPreferences.getInstance();
                                        prefs.setBool('isOccupationDetailsSaved', true);
