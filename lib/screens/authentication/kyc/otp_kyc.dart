...
class OTPKYC extends StatelessWidget {
  OTPKYC({super.key});

  final OTPKYCController cont = Get.put(OTPKYCController());
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 7,),
                    Text(
                      '•  Make sure you uploaded right documents images\n   as well and as soon Step 1 completes go to\n   continue.',
                      style: GoogleFonts.poppins(
                          fontSize: 12, color: Color(0xff333B63)),
                    ),
                    const SizedBox(
